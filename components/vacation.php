...
<?php
	...
	$sql = "SELECT activityid, Title, Review_points, Main_image, Description, Price_Range FROM locations INNER JOIN activities ON activities.locationid = locations.LocationID WHERE activities.vacationid = $vacationid";
	$result = $conn->query($sql);
?>
