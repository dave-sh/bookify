...
if (!isset($_SESSION["isLoggedIn"]) || $_SESSION["isLoggedIn"] !== true || !isset($_SESSION["login_user"])) {
    ...
    <div data-theme="cupcake" class="h-full min-h-screen flex flex-col bg-base-100">
        <div class="p-4 mt-8 w-4/5 sm:w-2/3 md:w-1/2 m-auto lg:w-1/3 bg-white rounded-xl shadow-md">
            ...
            <div class="text-center">
                <a class="font-bold text-primary hover:underline text-lg" href="../components/vacations.php">Go back</a>
            </div>
        </div>
    </div>
</body>
