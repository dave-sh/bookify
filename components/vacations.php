...
<body>
	...
	<div data-theme="cupcake" class="h-full min-h-screen flex flex-col bg-base-100">
		<div class="card w-2/3 mt-8 mb-4 mx-auto bg-base-100 p-4 shadow">
			<p class="text-3xl md:text-4xl italic">Your Vacations:</p>
		</div>
		<button onclick="location.href='addvacay.html'" class="btn btn-primary container w-2/3 mx-auto rounded-lg border-2 p-4 text-xl md:text-2xl text-center">
