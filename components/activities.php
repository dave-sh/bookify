	...
	<div id="introCard" class="card w-2/3 mt-12 mx-auto bg-base-100 shadow-xl overflow-auto">
		<div class="card-body">
			...
			<p class="text-3xl italic"><?php
				echo $_SESSION['place'];
				?></p>
			<input type="text" name="search" id="search" placeholder="Search for activities"
				   class="input input-bordered" onkeyup="searchData()"/>
				<select class="select w-1/5 bg-primary" id="sort" name="sort" onchange="sortData()">
